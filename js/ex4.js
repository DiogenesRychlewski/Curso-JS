...
var iniciado = false;
var hora_inicio, hora_atual, tempo_passado, init_cronometro, horas, minutos, segundos, milisegundos;
...
function valor_a_pagar(veiculo){
        ...
        switch(veiculo.categoria){
            ...
            //  default: console.log("Veículo de placa " + veiculo.placa + " não fez pagamento por erro de categoria(" + veiculo.categoria + ")");
             return 0;
